...
public class AcousticDrums extends AppCompatActivity { //----- CHANGE INSTANCE -----
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acoustic_drums); //----- CHANGE INSTANCE -----

        recyclerView = findViewById(R.id.recyclerViewAcousticDrums); //----- CHANGE INSTANCE -----
