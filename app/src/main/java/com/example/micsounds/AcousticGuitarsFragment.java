...
public class AcousticGuitarsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.activity_acoustic_guitars,container,false);

        recyclerView = view.findViewById(R.id.recyclerViewAcousticGuitars); //----- CHANGE INSTANCE -----
