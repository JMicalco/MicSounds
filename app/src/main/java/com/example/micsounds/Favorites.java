...
public class Favorites extends AppCompatActivity { //----- CHANGE INSTANCE -----
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_favorites); //----- CHANGE INSTANCE -----

        mAuth = FirebaseAuth.getInstance();

        recyclerView = findViewById(R.id.recyclerViewFavoritos); //----- CHANGE INSTANCE -----
