...
public class ElectricGuitarsFragment extends Fragment  {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.activity_electric_guitars,container,false);

        recyclerView = view.findViewById(R.id.recyclerViewElectricGuitars); //----- CHANGE INSTANCE -----

        LinearLayoutManager layoutManager = new LinearLayoutManager(getActivity());
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setHasFixedSize(true);
        searchView = view.findViewById(R.id.searchView6);
