...
public class ElectricGuitars extends AppCompatActivity { //----- CHANGE INSTANCE -----
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electric_guitars); //----- CHANGE INSTANCE -----

        recyclerView = findViewById(R.id.recyclerViewElectricGuitars); //----- CHANGE INSTANCE -----
